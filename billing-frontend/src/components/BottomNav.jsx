...
const BottomNav = () => {
  ...
  const navItems = [
    ...
    { name: t('users'), icon: UserIcon, path: '/users', roles: ['super_admin', 'admin'] },
  ];

  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-100 flex justify-between items-center px-4 py-3 z-[100] shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
